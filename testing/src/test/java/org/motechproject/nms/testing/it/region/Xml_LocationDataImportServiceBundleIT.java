...
public class Xml_LocationDataImportServiceBundleIT extends BasePaxIT {
...
//        taluka.addHealthBlock(healthBlock);
    ...
    public void testDistrictNameupdation() throws IOException {
        ...
        String fileName1 = "RCH_District_import1.xml";
        ...
        assertEquals("District_diff", districts1.get(1).getName());
        ...
        Thread.currentThread().setContextClassLoader(cl);
        districtDataService.evictAllCache();
        List <District> districts= districtDataService.retrieveAll();
    ...
    public void testTalukanameupdate() throws IOException {
        ...
        Thread.currentThread().setContextClassLoader(cl1);
        talukaDataService.evictAllCache();
        List<Taluka> talukas1 = talukaDataService.retrieveAll();
        assertEquals("Taluka_upd", talukas1.get(1).getName());
        transactionManager.commit(status);
    }
    ...
    public void testHealthBlocknameupdate() throws IOException {
        ...
        Thread.currentThread().setContextClassLoader(cl1);
        healthBlockDataService.evictAllCache();
    ...
    public void testHealthFacilityWithDuplicateId() throws IOException {
        ...
        Thread.currentThread().setContextClassLoader(cl1);
        healthFacilityDataService.evictAllCache();
        List<HealthFacility> healthFacilities1 = healthFacilityDataService.retrieveAll();
        assertEquals("HF_update1", healthFacilities1.get(1).getName());
    }
    ...
    public void testHealthSubFacilityWithDupId() throws IOException {
        ...
        // MotechEvent event = new MotechEvent("foobar", params);
        MotechEvent event = new MotechEvent(Constants.RCH_HEALTHSUBFACILITY_READ_SUBJECT, params);
        try {
        ...
        SimpleHttpServer simpleServer1 = SimpleHttpServer.getInstance();
        String url1 = simpleServer1.start("healthsubfacilityendpoint", 200, "abcd");
        URL endpoint1 = new URL(url1);
        LocalDate lastDateToCheck1 = DateUtil.today().minusDays(1);
        LocalDate yesterday1 = DateUtil.today().minusDays(1);
        ClassLoader cl1 = Thread.currentThread().getContextClassLoader();
        ...
        // MotechEvent event = new MotechEvent("foobar", params);
        MotechEvent event1 = new MotechEvent(Constants.RCH_HEALTHSUBFACILITY_READ_SUBJECT, params1);
        try {
            rchWebServiceFacade.readHealthSubFacilityResponseFromFile(event1);
        } catch (Exception e) {
            e.printStackTrace();
        ...
        Thread.currentThread().setContextClassLoader(cl1);
        healthSubFacilityDataService.evictAllCache();
    ...
    public void testVillageNameupdate() throws IOException {
        ...
        // MotechEvent event = new MotechEvent("foobar", params);
        MotechEvent event = new MotechEvent(Constants.RCH_VILLAGE_READ_SUBJECT, params);
        try {
        ...
        SimpleHttpServer simpleServer1 = SimpleHttpServer.getInstance();
        String url1 = simpleServer1.start("villageendpoint", 200, "abcd");
        URL endpoint1 = new URL(url1);
        LocalDate lastDateToCheck1 = DateUtil.today().minusDays(1);
        LocalDate yesterday1 = DateUtil.today().minusDays(1);
        ClassLoader cl1 = Thread.currentThread().getContextClassLoader();
        ...
        params1.put(Constants.FILE_NAME, fileName1);
        // MotechEvent event = new MotechEvent("foobar", params);
        MotechEvent event1 = new MotechEvent(Constants.RCH_VILLAGE_READ_SUBJECT, params1);
        try {
            rchWebServiceFacade.readVillageResponseFromFile(event1);
        } catch (Exception e) {
            e.printStackTrace();
        ...
        Thread.currentThread().setContextClassLoader(cl1);
        villageDataService.evictAllCache();
