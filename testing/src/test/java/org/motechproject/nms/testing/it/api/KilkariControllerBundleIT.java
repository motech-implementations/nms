...
public class KilkariControllerBundleIT extends BasePaxIT {
	...
	private void createLanguageAndSubscriptionPacks() {
		...
		gLanguageLocation = new LanguageLocation("10", new Circle("AA"),
				language, true);
		...
		gPack1 = subscriptionPackDataService.byName("childPack"); // 48 weeks, 1
																	// message
																	// per week
		gPack2 = subscriptionPackDataService.byName("pregnancyPack"); // 72
																		// weeks,
																		// 2
																		// messages
																		// per
	...
	private void setupData() {
		...
		subscriptionService.createSubscription(subscriber1.getCallingNumber(),
				gLanguageLocation, gPack1, SubscriptionOrigin.IVR);
	...
	public void testInboxRequest() throws IOException, InterruptedException {
		...
		String expectedJson = createInboxResponseJson(new HashSet<>(
				Arrays.asList(new InboxSubscriptionDetailResponse(subscription
						.getSubscriptionId().toString(), "childPack", "w1_1",
						"w1_1.wav"))));
	...
	public void testInboxRequestTwoSubscriptions() throws IOException,
		...
		subscriptionService.createSubscription(9999911122L, gLanguageLocation,
		...
		subscriptionService.createSubscription(9999911122L, gLanguageLocation,
				gPack2, SubscriptionOrigin.MCTS_IMPORT);
	...
	public void testInboxRequestSeveralSubscriptionsInDifferentStates()
		...
		subscriptionService.createSubscription(2000000000L, gLanguageLocation,
				gPack1, SubscriptionOrigin.MCTS_IMPORT);
	...
	private HttpPost createSubscriptionHttpPost(long callingNumber,
		...
		SubscriptionRequest subscriptionRequest = new SubscriptionRequest(
				callingNumber, "A", "AP", 123456789012545L, "10",
				subscriptionPack);
		ObjectMapper mapper = new ObjectMapper();
	...
	public void testCreateSubscriptionRequestDifferentPacks()
		...
		HttpPost httpPost1 = createSubscriptionHttpPost(callingNumber,
				"childPack");

		SimpleHttpClient.execHttpRequest(httpPost1, HttpStatus.SC_OK,
				ADMIN_USERNAME, ADMIN_PASSWORD);

		Subscriber subscriber = subscriberService.getSubscriber(callingNumber);
		int numberOfSubsBefore = subscriber.getActiveSubscriptions().size();

		HttpPost httpPost2 = createSubscriptionHttpPost(callingNumber,
				"pregnancyPack");

		SimpleHttpClient.execHttpRequest(httpPost2, HttpStatus.SC_OK,
				ADMIN_USERNAME, ADMIN_PASSWORD);
	...
	public void testCreateSubscriptionsNoLanguageInDB() throws IOException,
		...
		setupData();
		SubscriptionRequest subscriptionRequest = new SubscriptionRequest(
				9999911122L, "A", "AP", 123456789012545L, "99", "childPack");
		ObjectMapper mapper = new ObjectMapper();
		String subscriptionRequestJson = mapper
				.writeValueAsString(subscriptionRequest);
	...
	public void testCreateSubscriptionForUndeployedState() throws IOException,
		...
		SubscriptionRequest subscriptionRequest = new SubscriptionRequest(
				9999911122L, "A", "BB", 123456789012545L, "77", "childPack");
		ObjectMapper mapper = new ObjectMapper();
		String subscriptionRequestJson = mapper
				.writeValueAsString(subscriptionRequest);
		...
		assertTrue(SimpleHttpClient.execHttpRequest(httpPost,
				HttpStatus.SC_NOT_IMPLEMENTED, ADMIN_USERNAME, ADMIN_PASSWORD));
	}
	...
	public void testDeactivateSubscriptionRequest() throws IOException,
		...
		SubscriptionRequest subscriptionRequest = new SubscriptionRequest(
				1000000000L, "A", "AP", 123456789012545L, subscriptionId);
		ObjectMapper mapper = new ObjectMapper();
		String subscriptionRequestJson = mapper
				.writeValueAsString(subscriptionRequest);
	...
	public void testDeactivateSubscriptionRequestInvalidSubscription()
		...
		SubscriptionRequest subscriptionRequest = new SubscriptionRequest(
				1000000000L, "A", "AP", 123456789012545L,
