...
public class KilkariControllerBundleIT extends BasePaxIT {
 ...
 /**
     ...
     * MSISDN is subscribed for 72Weeks Pack. b)user's MSISDN is deactivated for
     * an old subscription of 72Weeks Pack.
     **/
    @Test
     ...
     * To check NMS is able to make available a single message of current week
     * in inbox with single message per week configuration . when a) user's
     * MSISDN is subscribed for 72Weeks Pack. b)user's MSISDN status is
     * completed for an old subscription of 72Weeks Pack.
     **/
    @Test
