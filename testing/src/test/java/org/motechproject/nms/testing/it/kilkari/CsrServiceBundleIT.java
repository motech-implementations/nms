...
public class CsrServiceBundleIT extends BasePaxIT {
    ...
    /*
    * To verify that 48WeeksPack Subscription should not be marked completed after just first retry.
    */
    @Test
    ...
    /**
     To verify that 72WeeksPack beneficiary will be  deactivated if the error “user number does not exist” is
    ...
    /**
     *To verify that 72WeeksPack beneficiary should not be  deactivated if the error “user number does
